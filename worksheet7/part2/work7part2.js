...
window.onload = function () {
    ...
    function render() {
        if (g_tex_ready > 5) {
            ...
            gl.uniformMatrix4fv(Vmatrix, false, flatten(lookAt(vec3(0.0, 0.0, 5.0), vec3(0.0, 0.0, -1.0), vec3(0.0, 1.0, 0.0))));
            gl.uniformMatrix4fv(Pmatrix, false, flatten(perspective(45.0, 1.0, 0.1, 100.0)));
