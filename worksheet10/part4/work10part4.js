window.onload = function () {
    ...
    var Vvalues = lookAt(eye, at, up);
    var Pvalues = perspective(30, canvas.width / canvas.height, 1, 50);
    ...
    function tick() {
        ...
        draw(gl, NumberofbufferIndicies, eye_dist_pan, at, up, qrot);
        requestAnimationFrame(tick, canvas);
    };

    function draw(gl, n, eye_dist_pan, lookat, up, qrot) {
                ...
                if (elapsed > 20) {
                    ...
                    switch (current_action) {
                        ...
                        case 2: { // dolly
                            ...
                            eye_dist_pan[0] = Math.max(eye_dist_pan[0], 0.01);
                        }
                            break;
                        case 3: { // pan
